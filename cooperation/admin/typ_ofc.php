<?php
	...
	//ambil isi field
	$fieldValues = getResults("SELECT _office_type._id as _id, _office_type._kode, _office_type._judul, _office_type._order, _status._nama FROM _office_type, _status WHERE _office_type._status = _status._id ORDER BY _id ASC", $conn);
