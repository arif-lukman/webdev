<?php
	...
	//sql commands
	//create
	$sqlC = "INSERT INTO _currency(_kode, _nama, _order, _status) VALUES ('$kode', '$nama', '$order', '$status')";
	//update
	$sqlU = "UPDATE _currency SET _kode='$kode', _nama='$nama', _order='$order', _status='$status' WHERE _id='$id'";
	//delete
	$sqlD = "DELETE FROM _currency WHERE _id='$id'";
