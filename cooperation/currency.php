<?php
	...
	//ambil isi field
	$fieldValues = getResults("SELECT _currency._id as _id, _currency._kode, _currency._nama, _currency._order, _status._nama FROM _currency, _status WHERE _currency._status = _status._id ORDER BY _id ASC", $conn);
	...
	<body>
		...
		<div class="container" style="margin-top: 80px">
			...
			<div class="well col-sm-9">
				...
				<?php
					//generate tabelnya
					generateTable($fieldNames, $fieldValues, $allValues, "currency.php");
				?>
				<br>
