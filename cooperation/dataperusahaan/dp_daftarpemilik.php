<?php
	...
	$colQuery = "SHOW columns FROM daftar_pemilik WHERE FIELD = 'No' or FIELD = 'Name' or FIELD = 'Phone_Number' or FIELD = 'Share'";

	$colExec = mysql_query($colQuery);
	
	//ambil isi field
	$conQuery = "SELECT No, Name, Phone_Number, Share FROM daftar_pemilik ORDER BY No ASC";
...
<div class="container-fluid" style="height:1000px">
				<h1>Daftar Pemilik (Shareholders)</h1>
