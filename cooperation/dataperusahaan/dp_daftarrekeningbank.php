<?php
	...
	$colQuery = "SHOW columns FROM daftar_rekening_bank WHERE FIELD = 'No' or FIELD = 'Bank_Name' or FIELD = 'Branch' or FIELD = 'Acc_Name' or FIELD = 'Acc_Number' or FIELD = 'Currency'";

	$colExec = mysql_query($colQuery);
	
	//ambil isi field
	$conQuery = "SELECT No, Bank_Name, Branch, Acc_Name, Acc_Number, Currency  FROM daftar_rekening_bank ORDER BY No ASC";
...
<div class="container-fluid" style="height:1000px">
				<h1>Daftar Rekening Bank (Bank Account)</h1>
