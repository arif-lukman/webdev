<?php
	...
	$colQuery = "SHOW columns FROM perusahaan_induk_dan_rekanan WHERE FIELD = 'No' or FIELD = 'Affiliate_Type' or FIELD = 'Address' or FIELD = 'Description'";

	$colExec = mysql_query($colQuery);
	
	//ambil isi field
	$conQuery = "SELECT No, Affiliate_Type, Address, Description FROM perusahaan_induk_dan_rekanan ORDER BY No ASC";
...
<div class="container-fluid" style="height:1000px">
				<h1>Perusahaan Induk Dan Rekanan (Holding Company and Partner)</h1>
