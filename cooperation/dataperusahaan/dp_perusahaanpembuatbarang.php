<?php
	...
	$colQuery = "SHOW columns FROM perusahaan_pembuat_barang WHERE FIELD = 'No' or FIELD = 'Product' or FIELD = 'Description'";

	$colExec = mysql_query($colQuery);
	
	//ambil isi field
	$conQuery = "SELECT No, Product , Description FROM perusahaan_pembuat_barang ORDER BY No ASC";
...
<div class="container-fluid" style="height:1000px">
				<h1>Perusahaan Pembuat Barang (Good Manufacturer)</h1>
