<?php
	...
	$colQuery = "SHOW columns FROM surat_dan_dokumen_pelengkap WHERE FIELD = 'No' or FIELD = 'Supporting_Document_Type' or FIELD = 'Description' or FIELD = 'Attachment'";
...
<div class="container-fluid" style="height:1000px">
				<h1>Surat dan Dokumen Pelengkap (Supporting Document)</h1>
