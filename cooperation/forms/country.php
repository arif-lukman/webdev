<?php
	...
	if($op == "update"){
		...
		//ambil data dari db
		$result = getResults("SELECT * FROM _country WHERE _id = '$id'", $conn);
	...
	<body>
		...
		<div class="container" style="margin-top: 80px">
			...
			<div class="well col-sm-9">
				...
				<form action="<?php echo '../controller/country.php?op=' . $op; if(isset($id)) echo '&id=' . $id;?>" method="post">
					<?php
						//bikin field pada form
						echo createInputField("text", "Kode Negara:", "kode", "kode", checkData($data,"_kode"), "", false, "");
						echo createInputField("text", "Nama Negara:", "nama", "nama", checkData($data,"_nama"), "", false, "");
