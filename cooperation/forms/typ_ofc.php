			...
			<div class="well col-sm-9">
				...
				<form action="<?php echo '../controller/typ_ofc.php?op=' . $op; if(isset($id)) echo '&id=' . $id;?>" method="post">
					<?php
						...
						echo createInputField("text", "Kode Tipe Kantor:", "kode", "kode", checkData($data,"_kode"));
						echo createInputField("text", "Judul Tipe Kantor:", "judul", "judul", checkData($data,"_judul"));
