<?php
	...
	if($op == "update"){
		...
		//ambil data dari db
		$result = getResults("SELECT * FROM _office_type WHERE _id='$id'", $conn);
	...
	<body>
		...
		<div class="container" style="margin-top: 80px">
			...
			<div class="well col-sm-9">
				...
				<form action="<?php echo '../controller/typ_ofc.php?op=' . $op; if(isset($id)) echo '&id=' . $id;?>" method="post">
					<?php
						//bikin field pada form
						echo createInputField("text", "Kode Tipe Kantor:", "kode", "kode", checkData($data,"_kode"), "", false, "");
						echo createInputField("text", "Judul Tipe Kantor:", "judul", "judul", checkData($data,"_judul"), "", false, "");
