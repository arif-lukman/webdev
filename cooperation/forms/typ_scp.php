			...
			<div class="well col-sm-9">
				...
				<form action="<?php echo '../controller/typ_scp.php?op=' . $op; if(isset($id)) echo '&id=' . $id;?>" method="post">
					<?php
						...
						echo createInputField("text", "Kode Tipe Bidang Pekerjaan:", "kode", "kode", checkData($data,"_kode"), "", false, "");
						echo createInputField("text", "Judul Tipe Bidang Pekerjaan:", "judul", "judul", checkData($data,"_judul"), "", false, "");
