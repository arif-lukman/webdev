	...
	<body>
		...
		<form class="col-sm-8" action="step4action.php" method="post">
			...
			<div class="col-sm-12 well well-lg">
				<?php
					echo createSelectOptionByName("Tipe Pengurus:", "Management_Type", "Management_Type", "---Pilih Tipe Kantor---", $conn1, "SELECT _id, _judul as _name FROM _manager_type ORDER BY _order ASC", false, "", "col-xs-4", true, $warning, "");
				?>			
				<div class="checkbox col-sm-12">
					<b>Pengurus Utama?</b>
					<label><input type="checkbox" value="1" name="Primary_Person"> Yes (Salah satu pengurus harus dibuat sebagai Pengurus Utama / One person must be set to Primary Person)</label>
					<br><br>
				</div>
				<?php
