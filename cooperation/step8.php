		...
		<form class="col-sm-8" action="step8action.php" method="post">
			...
			<hr>
				<?php
					...
					echo createSelectOptionByName("Negara:", "Country", "Country", "---Pilih Negara---", $conn1, "SELECT _id, _nama as _name FROM _country ORDER BY _order ASC", true, "", "col-xs-6", true, $warning, "");
					...
					echo createSelectOptionByName("Mata Uang:", "Currency", "Currency", "---Pilih Mata Uang---", $conn1, "SELECT _id, _nama as _name FROM _currency ORDER BY _order ASC", true, "", "col-xs-6", true, $warning, "");
				?>
				<div class="col-sm-12">
